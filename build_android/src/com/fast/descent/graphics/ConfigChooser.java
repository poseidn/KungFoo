...
public class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
	...
	/*
	 * Thomas: don't require OpenGL ES2 because the GPU in the emulation does
	 * not work private static int[] s_configAttribs2 = { EGL10.EGL_RED_SIZE, 4,
	...
	public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display) {
		...
		if (numConfigs <= 0) {
			throw new IllegalArgumentException(
					"Oops. No configs match configSpec");
		}
