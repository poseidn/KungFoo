...
void GameTemplates::registerTemplates(EntityEngine & entNg) {
	...
	registerUiElementEx("dpad1", { 8.0f, 8.0f }, 0.35f, LayerPriorityTopMost);
	registerUiElementEx("vbutton1", { 4.0f, 4.0f }, 0.35f, LayerPriorityTopMost);
	registerUiElementEx("vbutton2", { 4.0f, 4.0f }, 0.35f, LayerPriorityTopMost);
}
